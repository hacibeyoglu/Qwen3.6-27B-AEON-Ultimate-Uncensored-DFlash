...
| `--no-async-scheduling` | flag | Required for clean DFlash spec-decode acceptance metric capture; async scheduling double-counts spec-decode tokens in v0.20.0. | "Async scheduling is faster" — true for non-spec-decode workloads only |
